        ...
        <div className="legal-details">
          <details>
            ...
            <div>
              ...
              <p><strong>Dados coletados:</strong> nome, telefone, e-mail, localidade, preferências acadêmicas, dados profissionais de candidatos a parceiros e qualquer informação incluída voluntariamente nas mensagens.</p>
          ...
          <details>
            ...
            <div>
              <p>Os formulários desta versão não gravam dados em um banco próprio: eles preparam uma mensagem que o usuário decide enviar pelo WhatsApp. A Meta/WhatsApp trata esses dados conforme suas próprias políticas.</p>
          ...
          <details>
            ...
            <div>
              <p>A versão atual do site não instala cookies próprios de publicidade ou perfil comportamental. A hospedagem pode processar logs técnicos, como endereço IP, navegador, data e hora, para segurança e funcionamento.</p>
