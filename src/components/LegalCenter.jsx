        ...
        <div className="legal-details">
          <details>
            ...
            <div>
              ...
              <p><strong>Dados coletados:</strong> nome, WhatsApp, localidade, preferências acadêmicas, dados profissionais de candidatos a parceiros, e-mail quando informado e qualquer informação incluída voluntariamente nas mensagens.</p>
          ...
          <details>
            ...
            <div>
              <p>O formulário de admissão pede nome, WhatsApp e estado; o e-mail é opcional. Há um intervalo entre envios no mesmo aparelho. A leitura e a correção dos registros ficam restritas a operadores autorizados. Supabase e a hospedagem na Vercel participam desse processamento técnico conforme suas próprias políticas.</p>
          ...
          <details>
            ...
            <div>
              <p>O site não instala cookies próprios de publicidade ou perfil comportamental. A hospedagem pode processar dados técnicos como endereço IP, navegador, data e hora.</p>
